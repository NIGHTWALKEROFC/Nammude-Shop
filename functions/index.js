 ...
 *
 * NOT ATTACHING A CARD? See /scripts/send-push instead. It does this same
 * job (reads the same Firestore fields, sends through the same FCM
 * project) on a free GitHub Actions schedule — no Blaze plan required.
 */
